...
# Setup latch based clock gating
set_clock_gating_style -sequential_cell latch
set compile_clock_gating_through_hierarchy true

## Create Constraints 
create_clock gclk -name ideal_clock1 -period 6
...
# Generate SAIF file for PowerCompiler
write_saif -output fpu.saif -propagated
reset_switching_activity

# Dynamic Power Optimization
set_leakage_optimization false
set_dynamic_optimization true
read_saif -input rtl.saif -instance fpu

# Insert hierarchical clock gating 
...
## Below commands report area , cell, qor, resources, and timing information needed to analyze the design. 
  ...
  report_clock_gating > reports/synth_clock_gating.rpt
  report_power -analysis_effort high > reports/synth_power.rpt
